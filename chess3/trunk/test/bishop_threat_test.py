...
class BishopThreatTest(unittest.TestCase):
    ...
    def test_p1(self):
        size_x = 3
        size_y = 3
        crds = figures.bishop_threat(1, 1, size_y, size_x)
        ...
        self.assertTrue(self.check_threat(crds, 2, 2))


    def test_p2(self):
        size_x = 4
        size_y = 4
        crds = figures.bishop_threat(1, 2, size_y, size_x)
    ...
    def test_p3(self):
        size_x = 5
        size_y = 5
        crds = figures.bishop_threat(4, 2, size_y, size_x)
